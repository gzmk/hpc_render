...
writetable(T,'/scratch/gk925/hpc_render/render_scene2/bumpy_fitrender_Conditions.txt','Delimiter','\t')

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/hpc_render/render_scene2');
