...
writetable(T,'/scratch/gk925/hpc_render/render_spheronFit_LF1/bumpy_fitrender_Conditions.txt','Delimiter','\t')

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/hpc_render/render_spheronFit_LF1');
...
%     mappingsFile = 'bumpy5_hemilight_ortho2DefaultMappings.txt'
    ...
    hints.recipeName = ['Bump-',bump_level,'-','Gloss-',num2str(gloss_level),'-Scene1-' datetime];
    ...
    for renderer = {'Mitsuba'}
        ...
        montageName = sprintf('Bump%s_Gloss%s_Scene1', bump_level, num2str(gloss_level));
